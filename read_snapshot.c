...
int main(int argc, char **argv)
{
  ...
  sprintf(path, "/home/vee8497/Downloads/Gadget-2.0.7/Project/Results4");
  sprintf(basename, "snapshot");
  				/* number of snapshot */
  files = 1;
  
  for(i=1;i<argc;i++){
  snapshot_number = atoi(argv[i]);		/* number of snapshot */
...
{
	char base[20], path2[200], output_fname[200];
	int i;
printf("I was called\n");

	sprintf(path2, "/home/vee8497/Downloads/Gadget-2.0.7/Project/Results4");
	sprintf(base, "wsnapshot");
	sprintf(output_fname, "%s/%s_%03d.csv", path2, base, snapshot_number);
